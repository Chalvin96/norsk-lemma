...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--fresh",
        action="store_true",
        help="Call the LLM instead of reusing embedded or cached translations.",
    )
    args = parser.parse_args()
    args.reuse_existing_translations = not args.fresh
    args.reuse_cached_translations = not args.fresh
