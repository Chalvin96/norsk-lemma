...
# Superset of REDIRECT_RE: also catches "Se:", "Sjå:", and "jamfør" forms that
# carry an article_ref item. The \b boundary prevents matching the real verb
# "jamføre" (no boundary between "r" and "e").
